...
<div id="implementation-wrapper" class="services-service-block">
	...
	<div class="container">
		...
		<div class="row">
			...
			$args = array( 'post_type' => 'news', 'posts_per_page' => 3, 'orderby' => 'date', 'order' => 'DESC', 'category_name' => 'implementation' );
