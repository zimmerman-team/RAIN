<a class="anchor" id="advice"></a>
<div id="advice-wrapper" class="services-service-block">
	...
	<div class="container">
		...
		<div class="row">
			...
			$args = array( 'post_type' => 'news', 'posts_per_page' => 3, 'orderby' => 'date', 'order' => 'DESC', 'category_name' => 'advice' );
